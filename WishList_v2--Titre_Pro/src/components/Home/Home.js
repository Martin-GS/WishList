...
// Import images
import logo from '../../assets/images/wishlist-logotype.svg';
...
const Home = () => (
  ...
  <div className="home">
    ...
    <div className="jumbotron my-4">
      ...
      <h2><img className="logotype my-3 mx-auto d-block" src={logo} alt="WishList logotype" /></h2>
      <h4 className="text-center my-4">Toutes vos envies à portée de main !</h4>

      <div className="row">
        <div className="col d-none d-lg-block"> </div>

        <div className="col text-center mt-4">
          <a type="button" className="btn btn-primary text-white shadow" href="/signin" role="button">Se connecter</a>
        </div>

        <div className="col text-center mt-4">
          <a type="button" className="btn btn-primary text-white shadow" href="/signup" role="button">S'enregistrer</a>
        </div>
        <div className="col d-none d-lg-block"> </div>
      </div>
