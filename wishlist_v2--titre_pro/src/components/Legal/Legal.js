...
const Legal = () => {
  ...
  return (
    ...
    <div className="legal">
      ...
      <div className="row my-4">
        <div className="col">
          ...
          <div>
            ...
            <h5>Alors, juste ça, après on vous les balance</h5>
          ...
          <div>
            ...
            <h5>Voici nos mentions légales :</h5>
            ...
            <h6>Adresse de courrier électronique et numéro de téléphone</h6>
            <p>contact@wishlist.com - 09.74.76.80.67</p>

            <h6>Hébergeur du site</h6>
      ...
      <div className="row my-4">
        <div className="col text-center">
          <a type="button" className="btn btn-primary text-white shadow" onClick={() => history.goBack()}>
            Revenir en arrière
          </a>
        </div>
      </div>
